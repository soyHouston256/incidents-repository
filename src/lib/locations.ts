export const locations = {
  'Amazonas': { 
    ...
    'Luya': ['Lamud', 'Camporredondo', 'Cocabamba', 'Colcamar', 'Conila', 'Inguilpata', 'Longuita', 'Lonya Chico', 'Luya', 'Luya Viejo', 'María', 'Ocallí', 'Ocumal', 'Pisuquía', 'Providencia', 'San Cristóbal', 'San Francisco del Yeso', 'San Jerónimo', 'San Juan de Lopecancha', 'Santa Catalina', 'Santo Tomás', 'Tingo', 'Trita'], 
    'Rodríguez de Mendoza': ['Mendoza', 'Chirimoto', 'Cochamal', 'Huambo', 'Limabamba', 'Longar', 'Mariscal Benavides', 'Milpuc', 'Omia', 'San Nicolás', 'Totora', 'Vista Alegre'],
  ...
  'Áncash': { 
    ...
    'Bolognesi': ['Chiquián', 'Abelardo Pardo Lezameta', 'Antonio Raymondi', 'Aquia', 'Cajacay', 'Canis', 'Cátac', 'Chiquián', 'Huallanca', 'Huasta', 'Huayllacayán', 'La Primavera', 'Mangas', 'Pacllón', 'San Miguel de Corpanqui', 'Ticllos'], 
    ...
    'Huari': ['Huari', 'Anra', 'Cajay', 'Chavín de Huantar', 'Huacachi', 'Huacchis', 'Huachis', 'Huantar', 'Masin', 'Paucas', 'Ponto', 'Rahuapampa', 'Rapayán', 'San Marcos', 'San Pedro de Chaná', 'Uco'], 
    'Huarmey': ['Huarmey', 'Cochapeti', 'Culebras', 'Huayan', 'Malvas'], 
    'Huaylas': ['Caraz', 'Huallanca', 'Huata', 'Huaylas', 'Mato', 'Pamparomás', 'Pueblo Libre', 'Santa Cruz'], 
  ...
  'Apurímac': { 
    ...
    'Andahuaylas': ['Andahuaylas', 'Andarapa', 'Chiara', 'Huancarama', 'Huancaray', 'Huayana', 'Kaquiabamba', 'Kishuara', 'Pacobamba', 'Pacucha', 'Pampachiri', 'Pocohuanca', 'San Antonio de Cachi', 'San Jerónimo', 'Talavera', 'Tumay Huaraca', 'Turpo'], 
    'Aymaraes': ['Chalhuanca', 'Capaya', 'Caraybamba', 'Chacoche', 'Chaluanca', 'Chirihuana', 'Colcabamba', 'Cotaruse', 'Huayana', 'Justo Apu Sahuaraura', 'Lucre', 'Pocohuanca', 'San Juan de Chacña', 'Sañayca', 'Soraya', 'Tapayrihua', 'Tintay', 'Toraya', 'Yanaca'], 
  ...
  'Ayacucho': { 
    ...
    'Parinacochas': ['Coracora', 'Chumpi', 'Coronel Castañeda', 'Pacapausa', 'Pullo', 'Puyusca', 'San Francisco de Ravacayco'], 
  ...
  'Cajamarca': { 
    'Cajamarca': ['Cajamarca', 'Asunción', 'Chetilla', 'Cospán', 'Encañada', 'Jesús', 'Los Baños del Inca', 'Magdalena', 'Matara', 'Namora', 'San Juan'], 
    ...
    'San Marcos': ['San Marcos', 'Chancay', 'Eduardo Villanueva', 'Ichocán', 'José Sabogal', 'Pedro Gálvez'], 
  ...
  'Cusco': { 
    ...
    'La Convención': ['Quillabamba', 'Echarate', 'Huayopata', 'Inkawasi', 'Kimbiri', 'Maranura', 'Megantoni', 'Ocobamba', 'Pichari', 'Santa Ana', 'Santa Teresa', 'Vilcabamba', 'Villa Kintiarina'], 
  ...
  'Huánuco': { 
    ...
    'Leoncio Prado': ['Rupa-Rupa', 'Daniel Alomía Robles', 'Hermilio Valdizán', 'José Crespo y Castillo', 'Luyando', 'Mariano Dámaso Beraún', 'Pucayacu', 'Santo Domingo de Anda', 'Castillo Grande','Tingo Maria'], 
  ...
  'Junín': { 
    'Huancayo': ['Huancayo', 'Carhuacallanga', 'Chacapampa', 'Chicche', 'Chilca', 'Chongos Alto', 'Chupaca', 'Colca', 'Cullhuas', 'El Tambo', 'Huacrapuquio', 'Hualhuas', 'Huancán', 'Huayucachi', 'Ingenio', 'Pariahuanca', 'Pilcomayo', 'Pucará', 'Quichuay', 'Quilcas', 'San Agustín de Cajas', 'San Jerónimo de Tunán', 'Saño', 'Sapallanga', 'Sicaya', 'Santo Domingo de Acobamba', 'Viques'], 
  ...
  'La Libertad': {
    ...
    'Pacasmayo': ['Pacasmayo', 'Guadalupe', 'Jequetepeque', 'San José', 'San Pedro de Lloc'],
    'Pataz': ['Tayabamba', 'Buldibuyo', 'Chillia', 'Huancaspata', 'Huaylillas', 'Huayo', 'Ongón', 'Parcoy', 'Pías', 'Santiago de Challas', 'Taurija', 'Urpay'],
  ...
  'Lambayeque': {
    'Chiclayo': ['Chiclayo', 'Chongoyape', 'Eten', 'Eten Puerto', 'José Leonardo Ortiz', 'La Victoria', 'Lagunas', 'Monsefú', 'Nueva Arica', 'Oyotún', 'Picsi', 'Pimentel', 'Reque', 'Santa Rosa', 'Saña', 'Cayaltí', 'Patapo', 'Pomalca', 'Pucalá', 'Tuman'],
  ...
  'Lima': { 
    'Lima': ['Ancón', 'Ate', 'Barranco', 'Breña', 'Carabayllo', 'Chaclacayo', 'Chorrillos', 'Cieneguilla', 'Comas', 'El Agustino', 'Independencia', 'Jesús María', 'La Molina', 'La Victoria', 'Lima', 'Lince', 'Los Olivos', 'Lurigancho-Chosica', 'Lurin', 'Magdalena del Mar', 'Miraflores', 'Pachacamac', 'Pucusana', 'Pueblo Libre', 'Puente Piedra', 'Punta Hermosa', 'Punta Negra', 'Rímac', 'San Bartolo', 'San Borja', 'San Isidro', 'San Juan de Lurigancho', 'San Juan de Miraflores', 'San Luis', 'San Martín de Porres', 'San Miguel', 'Santa Anita', 'Santa María del Mar', 'Santa Rosa', 'Santiago de Surco', 'Surquillo', 'Villa El Salvador', 'Villa María', 'Villa María del Triunfo'],
    ...
    'Yauyos': ['Yauyos', 'Alis', 'Ayauca', 'Ayaviri', 'Azángaro', 'Cacra', 'Carania', 'Catahuasi', 'Chocos', 'Cochas', 'Colonia', 'Hongos', 'Huampará', 'Huancaya', 'Huangáscar', 'Huantán', 'Laraos', 'Lincha', 'Madeán', 'Miraflores', 'Omas', 'Putinza', 'Quinches', 'Quinocay', 'San Joaquín', 'San Pedro de Pilas', 'Tanta', 'Tauripampa', 'Tomas', 'Tupe', 'Viñac', 'Vitis'] 
    },
  'Loreto': {
  ...
  'San Martín': {
    ...
    'Rioja': ['Rioja', 'Awajun', 'Elías Soplín Vargas', 'Nueva Cajamarca', 'Pardo Miguel', 'Posic', 'San Fernando', 'Yorongos', 'Yuracyacu'],
  ...
  'Ucayali': {
    ...
    'Padre Abad': ['Padre Abad', 'Irázola', 'Curimana'],
    'Purús': ['Purús']
}};